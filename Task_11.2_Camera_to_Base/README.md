...
## Overview
To convert 3D coordinates from the camera frame (camera_link) to the vehicle's base frame (base_link), two spatial operations must be applied to each detected obstacle point:
